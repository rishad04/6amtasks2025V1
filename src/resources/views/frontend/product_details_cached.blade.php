        ...
        <div class="container d-lg-flex justify-content-between align-items-center">
            ...
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li class="current">product Details (Cached) </li>
                </ol>
            </nav>
        </div>
    </div><!-- End Page Title -->
                    ...
                    <div class="categories-widget widget-item">
                        ...
                        <ul class="mt-3">
                            ...
                            @foreach ($product_categories as $category)
                                <li><a href="{{ route('frontend.product-showcase-cached.index', $category->slug) }}">{{ $category->title }}<span>({{ $category->product()->count() }}
                                            Items)</span></a></li>
                            @endforeach
                        </ul>
                    ...
                    <div class="recent-posts-widget widget-item">
                        ...
                        @foreach ($latest_products as $item)
                            <div class="post-item">
                                ...
                                <div>
                                    <h4><a href="{{ route('frontend.product.details.cached', $item->slug) }}">{{ $item->title }}</a></h4>
                        ...
                        <div class="post-item">
                            <div>
                                <h4><a href="{{ route('frontend.product-showcase-cached.index') }}">View All</a></h4>
                                {{-- <h6><a href="#">{{ $item->productCategory?->title }}</a></h6>
                                <time datetime="2020-01-01">{{ $item->price }} Tk</time> --}}
                            </div>
                        </div><!-- End recent post item-->
